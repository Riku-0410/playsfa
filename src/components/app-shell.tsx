...
const NAV = [
  ...
  },
  {
    ...
    label: "設定",
    icon: (
      <path d="M8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm5.5-2a5.5 5.5 0 0 1-.06.8l1.3 1-1 1.74-1.54-.62a5.5 5.5 0 0 1-1.38.8L10.5 13.5h-2l-.32-1.78a5.5 5.5 0 0 1-1.38-.8l-1.54.62-1-1.73 1.3-1.01a5.6 5.6 0 0 1 0-1.6l-1.3-1 1-1.74 1.54.62a5.5 5.5 0 0 1 1.38-.8L8.5 2.5h2l.32 1.78c.5.2.96.47 1.38.8l1.54-.62 1 1.73-1.3 1.01c.04.26.06.53.06.8Z" />
    ),
  },
];
